...
module wav_mod
  ...
  implicit none
    ...
    real(ESMF_KIND_R8), allocatable     :: SSDWSX (:,:), SSDWSY(:,:)
    ...
    integer :: SSDWSX_varid, SSDWSY_varid
...
!-----------------------------------------------------------------------
    SUBROUTINE init_ww3_nc()
      ...
      character (len = *), parameter :: SSDWSX_NAME = "ssdwsx"
      character (len = *), parameter :: SSDWSY_NAME = "ssdwsy"
...
!-----------------------------------------------------------------------
    SUBROUTINE read_ww3_nc(currTime)
      ...
      !XYC added the sea-state-dependent wind stress:
      if(.not. allocated(SSDWSX)) allocate(SSDWSX(1:nnode,1))
