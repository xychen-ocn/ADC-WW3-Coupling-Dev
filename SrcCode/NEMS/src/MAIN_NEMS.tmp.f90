...
! 
      IF(PRINT_ESMF) THEN
        CALL ESMF_Initialize(VM             =VM                         & !<-- The ESMF Virtual Machine
                            ...
                            ,rc             =RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=141, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      ELSE
        CALL ESMF_Initialize(VM             =VM                         & !<-- The ESMF Virtual Machine
                            ,defaultCalKind =ESMF_CALKIND_GREGORIAN     & !<-- Set up the default calendar.
                            ,logkindflag    =ESMF_LOGKIND_NONE          & !<-- Define no log error output files;
                            ,rc             =RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=147, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      ENDIF
!
!-----------------------------------------------------------------------
...
! XYC uncommented for debugging purpose
!     write(*,*)'processor_name =',trim(PROCNAME)
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_VMGet(vm      =VM                                       &  !<-- The ESMF Virtual Machine
                     ...
                     ,rc      =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=170, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!                        ,logmsgAbort=(/ ESMF_LOGMSG_ERROR /)            &
                        ,rc         =RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=209, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      ENDIF
...
!
      CALL ESMF_ConfigLoadFile(config  =CF_MAIN                         &  !<-- The Configure object
                              ...
                              ,rc      =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=229, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      NEMS_GRID_COMP=ESMF_GridCompCreate(name        ='NEMS Grid Comp'  &  !<-- NEMS component name
                                        ...
                                        ,rc          =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=246, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_GridCompSetServices(NEMS_GRID_COMP                      &  !<-- The NEMS component
                                   ...
                                   ,rc=RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=262, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_TimeIntervalSet(timeinterval=TIMESTEP                   &  !<-- Main Clock's timestep
                               ...
                               ,rc          =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=288, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='start_year:'                 &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=304, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='start_month:'                &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=316, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='start_day:'                  &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=328, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='start_hour:'                 &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=340, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='start_minute:'               &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=352, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='start_second:'               &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=364, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_TimeSet(time=STARTTIME                                  &  !<-- The start time of the forecast (ESMF)
                       ...
                       ,rc  =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=380, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ConfigGetAttribute(config=CF_MAIN                       &
                                  ...
                                  ,label ='nhours_fcst:'                &
                                  ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=396, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
...
!
      CALL ESMF_TimeIntervalSet(timeinterval=RUNDURATION                &  !<-- The forecast length (s) (ESMF)
                               ,s           =NSECONDS_FCST              &
                               ,rc          =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=411, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
! pro forma, but now is replaced with RUNDURATION to become meaningful.
      ...
      CLOCK_MAIN=ESMF_ClockCreate(name       ='CLOCK_MAIN'              &  !<-- The top-level ESMF Clock
                                 ...
                                 ,rc         =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=434, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      NEMS_IMP_STATE=ESMF_StateCreate(name='NEMS Import State'     &
                                     ,rc       =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=449, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
      NEMS_EXP_STATE=ESMF_StateCreate(name='NEMS Export State'     &
                                     ,rc       =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=453, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!      
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_GridCompInitialize(gridcomp   =NEMS_GRID_COMP           &  !<-- The NEMS component
                                  ...
                                  ,userRc     =RC_USER                  &
                                  ,rc         =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=476, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      if (ESMF_LogFoundError(RC_USER, msg="Aborting NEMS", line=477, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_GridCompRun(gridcomp   =NEMS_GRID_COMP                  &  !<-- The NEMS component
                           ...
                           ,userRc     =RC_USER                         &
                           ,rc         =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=496, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      if (ESMF_LogFoundError(RC_USER, msg="Aborting NEMS", line=497, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ConfigGetAttribute(config = CF_MAIN                     &
                                  ...
                                  ,label  = 'RUN_CONTINUE:'             &
                                  ,rc     = RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=514, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
        CALL ESMF_ConfigGetAttribute(config = CF_MAIN                   &
                                    ...
                                    ,label  = 'HH_START:'               &
                                    ,rc     = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=533, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
        CALL ESMF_ConfigGetAttribute(config = CF_MAIN                   &
                                    ,value  = hh_final                  &
                                    ,label  = 'HH_FINAL:'               &
                                    ,rc     = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=539, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
...
!
        CALL ESMF_TimeIntervalSet(timeInterval = RUNDURATION            &
                                 ,h            = NHOURS_FCST            &
                                 ,rc           = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=552, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
        CALL ESMF_ClockGet(clock    = CLOCK_MAIN                        &
                          ,currTime = CURRTIME                          &
                          ,rc       = rc)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=557, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
...
!
        CALL ESMF_ClockSet(clock       = CLOCK_MAIN                     &
                          ...
                          ,currTime    = CURRTIME                       &
                          ,rc          = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=565, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
      END IF
!
...
!
      CALL ESMF_GridCompFinalize(gridcomp   =NEMS_GRID_COMP             &  !<-- The NEMS component
                                ...
                                ,userRc     =RC_USER                    &
                                ,rc         =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=586, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      if (ESMF_LogFoundError(RC_USER, msg="Aborting NEMS", line=587, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ClockDestroy(clock=CLOCK_MAIN                           &
                            ,rc   =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=601, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ConfigDestroy(config=CF_MAIN                            &
                             ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=615, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
      ...
      CALL ESMF_StateDestroy(state=NEMS_IMP_STATE                       &
                            ,rc   =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=625, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
      CALL ESMF_StateDestroy(state=NEMS_EXP_STATE                       &
                            ,rc   =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=629, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_GridCompDestroy(gridcomp=NEMS_GRID_COMP                 &
                               ,rc      =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=639, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
